  ...
  return (
    ...
    <Head />
      <body className='background flex flex-col gap-96 md:gap-12 lg:gap-4'>
        <Main />
        <NextScript />
        <footer className="flex text-center text-black textBackground border-t-2 border-b-2 border-black py-1 text-xs text-bold md:text-base md:justify-center md:mt-10 mt-5">
