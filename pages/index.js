            ...
            <div className="h-screen">
                <div className="w-3/5 h-[60%] flex flex-col text-center py-5 md:flex-row md:justify-center mx-auto">
                    <div className="my-auto textBackground p-4 rounded-md border-2 border-black">
                        ...
                        <p>Embark on a cyber odyssey with "CipherQuest"—a blog documenting a beginner's conquest of Hack The Box challenges. Join me on this riveting journey through triumphs and pitfalls. As a personal blog, CipherQuest shares experiences, not tutorials. Explore the thrill of HTB through a unique, narrative lens.</p>
                    </div>
